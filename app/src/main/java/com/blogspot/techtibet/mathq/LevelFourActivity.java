...
public class LevelFourActivity extends AppCompatActivity {
    ...
    void startnewgame() {
        ...
        new CountDownTimer(30100, 1000) {
            ...
            public void onFinish() {
                ...
                builder3=new AlertDialog.Builder(LevelFourActivity.this);
                ...
                int oldscore=preferences.getInt("key4",0);
                if(score>oldscore){
                    editor.putInt("key4",score);
                    editor.commit();
                }
                ...
                builder3.setNegativeButton("No,Go to home", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent=new Intent(LevelFourActivity.this,HomeActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayout1=(RelativeLayout)findViewById(R.id.relativelvl4);
        mTimer=(TextView)findViewById(R.id.timerlvl4);
        mExpression=(TextView)findViewById(R.id.explvl4);
        mMarks=(TextView)findViewById(R.id.marklvl4);
        button0=(Button)findViewById(R.id.button0lvl4);
        button1=(Button)findViewById(R.id.button1lvl4);
        button2=(Button)findViewById(R.id.button2lvl4);
        button3=(Button)findViewById(R.id.button3lvl4);
        mGoBtn=(Button)findViewById(R.id.gobtnlvl4);
        mMsgText=(TextView)findViewById(R.id.messagetextlvl4);
        mMsgImg=(CircleImageView)findViewById(R.id.messageimglvl4);
        mRelativeLevel2=(RelativeLayout)findViewById(R.id.relativelvl4main);
        preferences=this.getSharedPreferences("level4", Context.MODE_PRIVATE);
    ...
    public void choosenoption(View view){
        ...
        if(view.getTag().toString().equals(Integer.toString(locationofcorrect))){
            ...
            score++;
            MediaPlayer mediaPlayer=MediaPlayer.create(LevelFourActivity.this,R.raw.right);
            mediaPlayer.start();
            ...
            mMsgImg.setVisibility(View.VISIBLE);
            MediaPlayer mediaPlayer=MediaPlayer.create(LevelFourActivity.this,R.raw.wrong);
            mediaPlayer.start();
